var person = "my brother";
var locations = ['Boston', 'beach'];
var activities = ['relax', 'whales', 'walk', 'ocean'];
var food = ['seafood', 'lobster'];

document.getElementById('person').textContent = person;
document.getElementById('location').textContent = locations[0];
document.getElementById('secondLocation').textContent = locations[1];
document.getElementById('weather').textContent = 'Nice';
